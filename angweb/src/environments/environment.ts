...
export const environment = {
  production: false,
  codeChefLoginUrl: 'https://api.codechef.com/oauth/authorize?response_type=code&client_id=xxxxxxxxxxxxxxx&state=xyz&redirect_uri=http://{{Add your domain}}:3000/oauth/codechef',
